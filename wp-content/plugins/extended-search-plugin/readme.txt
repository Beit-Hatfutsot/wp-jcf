...
Tags: search box, javascript, useability, jquery
Requires at least: 3
Tested up to: 3.5
Stable tag: 0.6.2
...
1.	Set the default search text in the admin panel under `Settings > Enhanced Search Box`

== Screenshots ==

1. The Enhanced Search Fonts admin panel
